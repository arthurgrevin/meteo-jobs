...
class MeteoKafkaConsumer:
    def __init__(self, kafka_broker, topic, group_id="meteo_consumer_group", auto_offset_reset="earliest"):
        """
        ...
        :param auto_offset_reset: 'earliest' pour lire depuis le début ou 'latest' pour ne lire que les nouveaux messages
        """
